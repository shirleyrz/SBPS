(function (m, f) {
    var E = m.document, l = m.Modernizr, t = function (a) {
        return a.charAt(0).toUpperCase() + a.slice(1)
    }, y = ["Moz", "Webkit", "O", "Ms"], q = function (a) {
        var b = E.documentElement.style, c;
        if ("string" === typeof b[a])return a;
        a = t(a);
        for (var d = 0, e = y.length; d < e; d++)if (c = y[d] + a, "string" === typeof b[c])return c
    }, u = q("transform"), z = q("transitionProperty"), r = {csstransforms: function () {
        return!!u
    }, csstransforms3d: function () {
        var a = !!q("perspective");
        if (a) {
            var a = "@media (" + " -o- -moz- -ms- -webkit- -khtml- ".split(" ").join("transform-3d),(") +
                "modernizr)", b = f("<style>" + a + "{#modernizr{height:3px}}</style>").appendTo("head"), c = f('<div id="modernizr" />').appendTo("html"), a = 3 === c.height();
            c.remove();
            b.remove()
        }
        return a
    ...
    if (l)for (n in r)l.hasOwnProperty(n) || l.addTest(n, r[n]); else {
        var l = m.Modernizr = {_version: "1.6ish: miniModernizr for Isotope"}, v = " ", w;
        for (n in r)w = r[n](), l[n] = w, v += " " + (w ? "" : "no-") + n;
        f("html").addClass(v)
    }
    if (l.csstransforms) {
        var F = l.csstransforms3d ? {translate: function (a) {
            return"translate3d(" +
                a[0] + "px, " + a[1] + "px, 0) "
        }, scale: function (a) {
        ...
        f.cssHooks.scale = {set: function (a, b) {
            ...
            return(a = f.data(a, "isoTransform")) &&
                a.scale ? a.scale : 1
        }};
    ...
    var B, C;
    l.csstransitions && (B = {WebkitTransitionProperty: "webkitTransitionEnd", MozTransitionProperty: "transitionend", OTransitionProperty: "oTransitionEnd otransitionend", transitionProperty: "transitionend"}[z], C = q("transitionDuration"));
    var s = f.event,
        G = f.event.handle ? "handle" : "dispatch", x;
    ...
    f.Isotope.prototype = {_create: function (a) {
        ...
        if (f.isPlainObject(a)) {
            ...
            for (var b in a)if (a = "_update" + t(b), this[a])this[a]()
        }
        ...
        _filter: function (a) {
            ...
            a.each(function () {
                e = f(this);
                g = {};
                for (var a in d)g[a] = !b && "original-order" ===
                    a ? f.data(this, "isotope-sort-data")[a] : d[a](e, c);
            ...
            var c = !this.isLaidOut ? "css" : this.isUsingJQueryAnimation ? "animate" : "css", d = this.options.animationOptions, e = this.options.onLayout, g, h, k, j;
            h = function (a, b) {
                b.$el[c](b.style, d)
            };
            if (this._isInserting && this.isUsingJQueryAnimation)h = function (a, b) {
                ...
                var m = !1, n = [b, e, d.complete], q = this;
                k = !0;
                j = function () {
                    if (!m) {
                ...
                if (this.isUsingJQueryAnimation &&
                    "animate" === c)d.complete = j, k = !1; else if (l.csstransitions) {
            ...
            a.filter(":not(." + this.options.hiddenClass +
                ")").length ? (this.styleQueue.push({$el: a, style: this.options.hiddenStyle}), this._sort(), this.reLayout(d)) : d()
        }, shuffle: function (a) {
            ...
            for (d in this.originalStyle)c[d] =
            ...
            a = a ? "rows" : "cols";
            var e = this.element[d](), d = this.options[b] && this.options[b][c] || this.$filteredAtoms["outer" + t(d)](!0) || e, e = Math.floor(e / d), e = Math.max(e, 1);
            this[b][a] = e;
            this[b][c] = d
        }, _checkIfSegmentsChanged: function (a) {
            var b = this.options.layoutMode,
                c = a ? "rows" : "cols", d = this[b][c];
            this._getSegments(a);
            return this[b][c] !== d
            ...
            a.each(function () {
                ...
                if (1 === e)b._masonryPlaceBrick(a, c.colYs); else {
                    var g = c.cols + 1 - e, h = [], k, j;
        ...
        _straightDownLayout: function (a) {
            ...
            var b =
                this, c = b.masonryHorizontal;
            a.each(function () {
                var a = f(this), e = Math.ceil(a.outerHeight(!0) / c.rowHeight), e = Math.min(e, c.rows);
                if (1 === e)b._masonryHorizontalPlaceBrick(a, c.rowXs); else {
                    var g = c.rows + 1 - e, h = [], k, j;
            ...
            a.each(function () {
                var a = f(this), e = c.index % c.rows, g = (Math.floor(c.index / c.rows) + 0.5) * c.columnWidth - a.outerWidth(!0) /
                    2, e = (e + 0.5) * c.rowHeight - a.outerHeight(!0) / 2;
                b._pushPosition(a, g, e);
                c.index++
            })
    ...
    f.fn.imagesLoaded = function (a) {
        ...
        var d = this, e = d.find("img").add(d.filter("img")), g = e.length, h = "data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==", k = [];
        g || b();
        e.bind("load.imagesLoaded error.imagesLoaded",
            c).each(function () {
                var a = this.src;
                this.src = h;
                this.src = a
