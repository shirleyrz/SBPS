(function (a) {
    a.fn.superfish = function (f) {
        var d = a.fn.superfish, e = d.c, g = a('<span class="' + e.arrowClass + '"> &#187;</span>'), k = function (c) {
            var b = a(this), d = j(b);
    ...
    g.o = [];
    g.op = {};
    g.c = {bcClass: "sf-breadcrumb", menuClass: "sf-js-enabled", anchorClass: "sf-with-ul", arrowClass: "sf-sub-indicator"};
    g.defaults = {hoverClass: "sfHover", pathClass: "overideThisToUse",
        pathLevels: 1, delay: 800, animation: {opacity: "show"}, animationOut: {opacity: "hide"}, speed: "normal", speedOut: "fast", autoArrows: !0, disableHI: !1, useClick: !1, onInit: function () {
    ...
    a.fn.extend({hideSuperfishUl: function () {
        var f = g.op, d = !0 === f.retainPath ? f.$path : "";
        f.retainPath = !1;
        ...
        var a = g.op, d = this.addClass(a.hoverClass).find(">ul:hidden").css("visibility", "visible");
